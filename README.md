...
We compare our index calculations in [compare_CAT_indices_using_BARRA-R_sample.ipynb](https://github.com/xenct/turbulence_AUSCAT/blob/main/compare_CAT_indices_using_BARRA-R_sample.ipynb)
